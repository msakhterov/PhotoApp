...
import ru.msakhterov.photoapp.ui.adapters.DBFragmentPagerAdapter;
import timber.log.Timber;

public class DBFragment extends Fragment implements PhotoListUpdatable {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new DBFragmentPagerAdapter(getChildFragmentManager());
